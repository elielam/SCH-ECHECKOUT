...
namespace e_checkout.Template
{
    partial class AddModal
    {
        ...
        /// </summary>
        private void InitializeComponentStock()
        {
            ...
            this.Name = "AddModal";
            this.Text = "Add Stock";
            this.Load += new System.EventHandler(this.AddModal_Load);
        ...
        private void InitializeComponentProduct()
        {
            this.groupBoxForm = new System.Windows.Forms.GroupBox();
            this.textBoxId = new System.Windows.Forms.TextBox();
        ...
        private void InitializeComponentPayment()
        {
            this.groupBoxForm = new System.Windows.Forms.GroupBox();
            this.textBoxId = new System.Windows.Forms.TextBox();
